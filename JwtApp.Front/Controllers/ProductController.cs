    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            if (token != null)
            {
                ...
                var response = await client.GetAsync("http://localhost:5073/api/products");
        ...
        public async Task<IActionResult> Remove(int id)
        {
            ...
            if (token != null)
            {
                var client = _httpClientFactory.CreateClient();
                client.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", token);
                await client.DeleteAsync($"http://localhost:5073/api/products/{id}");
            }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            if (token != null)
            {
                ...
                var client = _httpClientFactory.CreateClient();
                client.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", token);
                var response = await client.GetAsync("http://localhost:5073/api/categories");
                if (response.IsSuccessStatusCode)
                {
                    var jsonData = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Create(CreateProductModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (token != null)
                {
                    ...
                    var response = await client.PostAsync("http://localhost:5073/api/products", content);
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            if (token != null)
            {
                ...
                var responseProduct = await client.GetAsync($"http://localhost:5073/api/products/{id}");
                ...
                if (responseProduct.IsSuccessStatusCode)
                {
                    ...
                    var responseCategory = await client.GetAsync($"http://localhost:5073/api/categories");
        ...
        public async Task<IActionResult> Update(UpdateProductModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (token != null)
                {
                    ...
                    var response = await client.PutAsync($"http://localhost:5073/api/products", content);
